...
def generate_test_runner(file_name, visibility=None):
    native.genrule(
        ...
        cmd = "$(location @UnityTestRunnerGeneration//:Generator) $(SRCS) $(OUTS)",
        tools = ["@UnityTestRunnerGeneration//:Generator",],
...
"""
def unity_test(file_name, deps=None, copts=None, size="small", linkopts=None, visibility=None):
